...
class VulkanUIGen:
    ...
    def run(self):
        print("[*] Generando módulo ui_gen.rs para Custom Chrome (Top Bar)...")
        code = [
        ...
        with open(os.path.join(self.output_dir, "ui_gen.rs"), "w", encoding='utf-8') as f:
            f.write("\n".join(code))
        ...
        if os.path.exists(mod_file):
            with open(mod_file, "r") as f:
                content = f.read()
            if "pub mod ui_gen;" not in content:
